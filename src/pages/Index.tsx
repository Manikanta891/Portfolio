        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
          ...
          <div className="animate-fade-in text-center lg:text-left">
            ...
            <h1 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-foreground leading-tight mb-4">
              Manikanta Sandula
              <br />
              <span className="text-muted-foreground">Full Stack Developer | AI Explorer</span>
            </h1>
            <p className="text-sm sm:text-base text-muted-foreground max-w-lg mx-auto lg:mx-0 leading-relaxed mb-3">
              I’m Manikanta Sandula, a computer science student who focuses on solving real-world problems. I like building things that actually matter, not just writing code for the sake of it. I believe in keeping things simple, practical, and impactful.



            </p>
            <p className="text-sm sm:text-base text-muted-foreground max-w-lg mx-auto lg:mx-0 leading-relaxed mb-5">
              I’m always learning, experimenting, and pushing myself to get better. Whether it’s coding, problem solving, or creating something from scratch, I bring focus, consistency, and a strong mindset to everything I do.

            </p>

             <p className="text-sm sm:text-base text-muted-foreground max-w-lg mx-auto lg:mx-0 leading-relaxed mb-5">
              For me, it’s not just about becoming a developer. It’s about becoming someone who can think clearly, build smart solutions, and make a real difference.
          ...
          <div className="flex justify-center items-center animate-fade-in order-first lg:order-last" style={{ animationDelay: "200ms" }}>
            <div className="relative w-full max-w-xs sm:max-w-sm lg:max-w-lg">
              ...
              <div className="relative backdrop-blur-sm bg-card/20 p-2 rounded-2xl border border-border/50 shadow-2xl">
                <img 
                  src={getAssetPath("mani_image.png")} 
                  alt="Manikanta Sandula" 
