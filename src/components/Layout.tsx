...
const socialLinks = [
  { href: "https://github.com/Manikanta891", icon: Github, label: "GitHub" },
  { href: "https://www.linkedin.com/in/manikanta-sandula/", icon: Linkedin, label: "LinkedIn" },
];
      ...
      <footer className="border-t border-border/50 py-4 sm:py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-4 sm:gap-5">
            <a href="https://github.com/Manikanta891" target="_blank" rel="noopener noreferrer" className="text-xs text-muted-foreground hover:text-foreground transition-colors">GitHub</a>
            <a href="https://www.linkedin.com/in/manikanta-sandula/" target="_blank" rel="noopener noreferrer" className="text-xs text-muted-foreground hover:text-foreground transition-colors">LinkedIn</a>
          </div>
        </div>
      </footer>
    </div>
